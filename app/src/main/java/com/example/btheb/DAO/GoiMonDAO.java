...
public class GoiMonDAO {
    ...
    public long ThemGoiMon (GoiMonDTO goiMonDTO) {
        ...
        long magoimon = db.insert(CreateDatabase.TB_GOIMON, null, contentValues);
        return magoimon;
    }
    ...
    public long LayMaGoiMonTheoMaBan(int maban,String tinhtrang){
        ...
        while (!cursor.isAfterLast()){
            magoimon = cursor.getInt(cursor.getColumnIndexOrThrow(CreateDatabase.TB_GOIMON_MAGOIMON));
    ...
    public boolean CapNhatSoLuong(ChiTietGoiMonDTO chiTietGoiMonDTO){
        ...
        long kiemtra = db.update(CreateDatabase.TB_CHITIETGOIMON,contentValues,CreateDatabase.TB_CHITIETGOIMON_MAGOIMON + " = " + chiTietGoiMonDTO.getMaGoiMon()
    ...
    public boolean ThemChiTietGoiMon(ChiTietGoiMonDTO chiTietGoiMonDTO){
        ...
        long kiemtra = db.insert(CreateDatabase.TB_CHITIETGOIMON, null, contentValues);
    ...
    public List<ThanhToanDTO> LayDanhSachMonAnTheoMaGoiMon(int magoimon){
        ...
        while(!cursor.isAfterLast()){
            ...
            thanhToanDTO.setSoLuong(cursor.getInt(cursor.getColumnIndexOrThrow(CreateDatabase.TB_CHITIETGOIMON_SOLUONG)));
            thanhToanDTO.setGiaTien(cursor.getInt(cursor.getColumnIndexOrThrow(CreateDatabase.TB_MONAN_GIATIEN)));
            thanhToanDTO.setTenMonAn(cursor.getString(cursor.getColumnIndexOrThrow(CreateDatabase.TB_MONAN_TENMONAN)));
    ...
    public boolean CapNhatTrangThaiGoiMonTheoMaBan(int maban,String tinhtrang){
        ...
        long kiemtra = db.update(CreateDatabase.TB_GOIMON, contentValues,CreateDatabase.TB_GOIMON_MABAN + " = '" + maban + "'",null);
